...
If you have questions please read the [FAQ](https://github.com/InteractiveLab/TouchScript/wiki/FAQ) first. After that search [the Forum](http://touchprefab.com/index.php). If you are sure that you found a bug post an [issue](https://github.com/InteractiveLab/TouchScript/issues).
